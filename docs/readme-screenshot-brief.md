# README Screenshot Brief

This brief defines the first product screenshot for the public Marka README. It is intentionally separate from the landing-page recording plan: one still image must answer what Marka is at a glance, while the landing page will later carry richer motion and multiple demonstrations.
...
If the primary frame cannot make the retained context clear, capture one additional detail screenshot for later use:

- Filename: screenshots/marka-bookmark-context.webp
- Surface: a saved engineering article or course document open in reader or preview view.
- Must visibly show a preview or readable content plus title and tags.
- Do not add it to the README unless it improves understanding more than it adds length. It remains useful for the future landing page and docs.
